...
//3- Importamos el módulo telaRoutes (se lo diseñará a futuro)
const telaRoutes = require('../routes/telasRouter');
const categoriaRoutes = require('../routes/categoriasRouter');
